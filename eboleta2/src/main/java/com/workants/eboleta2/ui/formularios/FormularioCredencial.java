...
public class FormularioCredencial extends FormLayout{
	...
	public FormularioCredencial(){
		...
		addComponent(new Label("<b><i><font color='#FF0000' size='3'>*</font><font size='3'>Ubicado en la parte central de la boleta impresa  mensual",ContentMode.HTML));
...
//		this.getSeleccionadorImpuesto().setItemIcon(5, VaadinIcons.PACKAGE);
	...
	private Component generarTxtNumeroPartida() {
		...
		this.getTxtNumeroDePartida().setWidth("350px");
