...
//public class FormLayoutCuitResponsive extends FormLayout implements ValueChangeListener{
public class FormLayoutCuitResponsive extends VerticalLayout implements ValueChangeListener{
	...
	public FormLayoutCuitResponsive() {
	...
	public FormLayoutCuitResponsive(Juridica juridica) {
